...
function onClear(slotData)
    ...
    Tracker:FindObjectForCode("setting_gemsanity_reward_type").CurrentStage = 0
    Tracker:FindObjectForCode("setting_gemsanity_gem_bundle_size").AcquiredCount = 0
    ...
    if sd_options['gemsanity_reward_type'] then
        Tracker:FindObjectForCode("setting_gemsanity_reward_type").CurrentStage = sd_options['gemsanity_reward_type']
        --Bundle = 0 , Gems = 1
        if sd_options['gemsanity_reward_type'] == 0 then
            Tracker:FindObjectForCode("setting_gemsanity_gem_bundle_size").AcquiredCount = sd_options['gemsanity_gem_bundle_size']
            GEM_BUNDLE = sd_options['gemsanity_gem_bundle_size']
        end
        print("GEM_BUNDLE (within setup): " .. GEM_BUNDLE)
    end
